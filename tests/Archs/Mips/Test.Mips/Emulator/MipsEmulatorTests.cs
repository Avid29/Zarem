...
public partial class MipsEmulatorTests
{
    ...
    [DataTestMethod("MipsIII_32bit (JIT)")]
    ...
    [DataTestMethod("MipsIV_32bit (JIT)")]
    ...
    [DataTestMethod("MipsV_32bit (JIT)")]
