...
public partial class AssemblySyntaxColorScheme : DependencyObject
{
    ...
    public static readonly DependencyProperty BackgroundColorProperty =
        DependencyProperty.Register(nameof(BackgroundColor),
            typeof(Color),
            typeof(AssemblySyntaxColorScheme),
            new PropertyMetadata(Colors.Transparent));

    /// <summary>
    /// Initializes a new instance of the <see cref="AssemblySyntaxColorTheme"/> class.
    /// </summary>
    ...
    public static AssemblySyntaxColorScheme Current => new(CurrentScheme);
